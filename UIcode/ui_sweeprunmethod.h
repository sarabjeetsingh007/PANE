...
public:
    ...
    QCheckBox *routingFunctionCheckbox_7;
    ...
    void setupUi(QWidget *SweepRunMethod)
    {
        ...
        routingFunctionGroupBox->setGeometry(QRect(400, 130, 421, 80));
        routingFunctionCheckbox_7 = new QCheckBox(routingFunctionGroupBox);
        ...
        routingFunctionButtonGroup->addButton(routingFunctionCheckbox_7);
        routingFunctionCheckbox_7->setObjectName(QStringLiteral("routingFunctionCheckbox_7"));
        routingFunctionCheckbox_7->setGeometry(QRect(220, 50, 91, 22));
        ...
        routingFunctionCheckbox_5->setGeometry(QRect(10, 50, 91, 22));
        ...
        routingFunctionCheckbox_4->setGeometry(QRect(330, 20, 91, 22));
        ...
        routingFunctionCheckbox_3->setGeometry(QRect(220, 20, 91, 22));
        ...
        routingFunctionCheckbox_6->setGeometry(QRect(110, 50, 91, 22));
        ...
        trafficPatternGroupBox->setGeometry(QRect(400, 240, 421, 80));
        ...
        trafficPatternCheckbox_3->setGeometry(QRect(220, 20, 141, 22));
        ...
        trafficPatternCheckbox_6->setGeometry(QRect(220, 50, 131, 22));
        ...
        trafficPatternCheckbox_5->setGeometry(QRect(110, 50, 91, 22));
        ...
        trafficPatternButtonGroup->addButton(trafficPatternCheckbox_4);
        trafficPatternCheckbox_4->setObjectName(QStringLiteral("trafficPatternCheckbox_4"));
        trafficPatternCheckbox_4->setGeometry(QRect(10, 50, 91, 22));
    ...
    void retranslateUi(QWidget *SweepRunMethod)
    {
        ...
        routingFunctionCheckbox_7->setText(QApplication::translate("SweepRunMethod", "bitrev", Q_NULLPTR));
        routingFunctionCheckbox_5->setText(QApplication::translate("SweepRunMethod", "transpose", Q_NULLPTR));
        routingFunctionCheckbox_4->setText(QApplication::translate("SweepRunMethod", "shuffle", Q_NULLPTR));
        routingFunctionCheckbox_1->setText(QApplication::translate("SweepRunMethod", "Neighbor", Q_NULLPTR));
        routingFunctionCheckbox_3->setText(QApplication::translate("SweepRunMethod", "tornado", Q_NULLPTR));
        routingFunctionCheckbox_2->setText(QApplication::translate("SweepRunMethod", "uniform", Q_NULLPTR));
        routingFunctionCheckbox_6->setText(QApplication::translate("SweepRunMethod", "bitcomp", Q_NULLPTR));
        trafficPatternGroupBox->setTitle(QString());
        trafficPatternCheckbox_3->setText(QApplication::translate("SweepRunMethod", "adaptive xy-yx", Q_NULLPTR));
        trafficPatternCheckbox_6->setText(QApplication::translate("SweepRunMethod", "planar adapt", Q_NULLPTR));
        trafficPatternCheckbox_5->setText(QApplication::translate("SweepRunMethod", "min-adapt", Q_NULLPTR));
        trafficPatternCheckbox_1->setText(QApplication::translate("SweepRunMethod", "dor", Q_NULLPTR));
        trafficPatternCheckbox_2->setText(QApplication::translate("SweepRunMethod", "xy-yx", Q_NULLPTR));
        trafficPatternCheckbox_4->setText(QApplication::translate("SweepRunMethod", "romm", Q_NULLPTR));
    } // retranslateUi
