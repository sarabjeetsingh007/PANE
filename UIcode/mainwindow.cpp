...
//    }
    ...
    process.start("gnome-terminal -x sh -c \"(cd ../PANE/ ; python client_generate.py" + inputArguments + ";)\"");
    process.waitForFinished();
...
//    QProcess::execute ("sed -i \"/#define numRouters / c #define numRouters " + numOfRoutersStr + "\" ../booksim2-master/src/routers/socket_lib.cpp"); //Will be done through ./temp/socket_gen.py
...
//    QProcess::execute ("sed -i \"/#define numRouters / c #define numRouters " + numOfRoutersStr + "\" ../PANE/socket_lib.cc");   //Will be done through socket_gen.py
    ...
    switch(mTopology){
       case 0  :
            QProcess::execute ("sed -i \"/maxH=/ c maxH=" + routerRow + "\" ../PANE/ned_files/network_ned_connections_mesh.py");
            QProcess::execute ("sed -i \"/maxV=/ c maxV=" + routerCol + "\" ../PANE/ned_files/network_ned_connections_mesh.py");
            process.start("gnome-terminal -x sh -c \"(cd ../PANE/ned_files/ ; python network_ned_connections_mesh.py;)\"");
            process.waitForFinished();
            break; //optional
       case 1 :
            QProcess::execute ("sed -i \"/maxH=/ c maxH=" + routerRow + "\" ../PANE/ned_files/network_ned_connections_torus.py");
            QProcess::execute ("sed -i \"/maxV=/ c maxV=" + routerCol + "\" ../PANE/ned_files/network_ned_connections_torus.py");
            process.start("gnome-terminal -x sh -c \"(cd ../PANE/ned_files/ ; python network_ned_connections_torus.py;)\"");
            process.waitForFinished();
            break; //optional
    ...
    QProcess::execute ("sed -i \"/numRouters = / c numRouters = " + numOfRoutersStr + "\" ../PANE/socket_gen.py");
    process.start("gnome-terminal -x sh -c \"(cd ../PANE/ ; python socket_gen.py;)\"");
    process.waitForFinished();

    // Changing booksim/src/routers/socket_lib.cpp
    QProcess::execute ("sed -i \"/numRouters = / c numRouters = " + numOfRoutersStr + "\" ../booksim2-master/src/routers/temp/socket_gen.py");
    process.start("gnome-terminal -x sh -c \"(cd ../booksim2-master/src/routers/temp/ ; python socket_gen.py;)\"");
    process.waitForFinished();
...
//        process.start("gnome-terminal -x sh -c \"(make -C ../PANE/; make sock -C ../PANE/; gnome-terminal -x sh -c \\\"(sleep 2; cd ../booksim2-master/src/;   ./run.sh > dump;)\\\"; cd ../PANE/; ./PANE -u Cmdenv -f omnetpp.ini;)\"");
//        process.waitForFinished(-1);
