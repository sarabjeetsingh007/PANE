...
public:
    ...
    void setupUi(QWidget *ConfigInput)
    {
        ...
        packetSize->setGeometry(QRect(530, 300, 124, 27));
    ...
    void retranslateUi(QWidget *ConfigInput)
    {
        ...
        packetSize->setText(QApplication::translate("ConfigInput", "5", Q_NULLPTR));
        ...
        simulationData_SyntheticDropdown->insertItems(0, QStringList()
         ...
         << QApplication::translate("ConfigInput", "diagonal", Q_NULLPTR)
         << QApplication::translate("ConfigInput", "assymetric", Q_NULLPTR)
         << QApplication::translate("ConfigInput", "taper64", Q_NULLPTR)
        );
