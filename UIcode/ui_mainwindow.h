...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        build->setGeometry(QRect(320, 460, 111, 31));
        ...
        line_2->setGeometry(QRect(50, 430, 521, 20));
        line_2->setFrameShape(QFrame::HLine);
        line_2->setFrameShadow(QFrame::Sunken);
        run = new QPushButton(centralWidget);
        run->setObjectName(QStringLiteral("run"));
        run->setGeometry(QRect(460, 460, 111, 31));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_6->setText(QApplication::translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; color:#901c1c;\">Define Network</span></p></body></html>", Q_NULLPTR));
        ...
        numCols->setText(QApplication::translate("MainWindow", "3", Q_NULLPTR));
        numRows->setText(QApplication::translate("MainWindow", "3", Q_NULLPTR));
