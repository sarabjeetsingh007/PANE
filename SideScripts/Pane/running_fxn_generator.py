...
routingFunctionData = ''
trafficPatternData = '0,5'

routingFunctionList = ['neighbor', 'uniform', 'tornado', 'shuffle', 'transpose', 'bitcomp', 'bitrev']
trafficPatternList = ['dor', 'xy-yx', 'adaptive xy-yx', 'romm', 'min-adapt', 'planar adapt']
