...
int Packet::getPid() const
{
    return this->pid;
}

void Packet::setPid(int pid)
{
    this->pid = pid;
}

int Packet::getHid() const
{
    return this->hid;
}

void Packet::setHid(int hid)
{
    this->hid = hid;
}

double Packet::getDelay() const
{
    return this->delay;
}
...
int Packet::getPacket_type() const
{
    return this->packet_type;
}

void Packet::setPacket_type(int packet_type)
{
...
int PacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='h' && strcmp(fieldName, "hid")==0) return base+1;
...
std::string PacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: return long2string(pp->getHid());
        case 2: return double2string(pp->getDelay());
        case 3: return long2string(pp->getPacket_type());
...
bool PacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 1: pp->setHid(string2long(value)); return true;
        case 2: pp->setDelay(string2double(value)); return true;
        case 3: pp->setPacket_type(string2long(value)); return true;
