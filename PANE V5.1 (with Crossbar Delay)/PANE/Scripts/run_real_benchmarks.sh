...
make -j4 sock
ulimit -n 4096
gnome-terminal -x sh -c "(sleep 1; cd ../booksim2-master/src/; ulimit -n 4096; ./run.sh > dumpblackscholes_64c_simmedium; )"
./PANE -u Cmdenv -f omnetpp.ini

sed -i -e 's/blackscholes_64c_simmedium/bodytrack_64c_simlarge/g'   ../booksim2-master/src/examples/mesh88_lat_blackscholes
make -j80
make -j4 sock
ulimit -n 4096
